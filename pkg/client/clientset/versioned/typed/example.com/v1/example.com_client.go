...
import (
	...
	"github.com/xigang/kube-crd-controller/pkg/client/clientset/versioned/scheme"
...
func (c *ExampleV1Client) MyCustomResources(namespace string) MyCustomResourceInterface {
